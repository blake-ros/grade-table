      ...
      <form className="col-md-3" onSubmit={this.props.addGrade()}>
        ...
        <div className="form-group ml-2">
          ...
          <div className="input-group mb-3">
            ...
            <input name="course" className="form-control form-control-lg" type="text" placeholder="Course" id="course" value={this.state.value} onChange={this.handleChange}></input>
          </div>
          <div className="input-group mb-3">
            <i className="fas fa-graduation-cap fa-md input-group-prepend input-group-text d-flex"></i>
            <input name="grade" className="form-control form-control-lg" type="text" placeholder="Grade" id="grade" value={this.state.value} onChange={this.handleChange}></input>
          </div>
